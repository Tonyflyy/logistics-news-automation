...
class Config:
    ...
    HOLIDAY_NAME_TRANSLATIONS = {
        ...
        "Martin Luther King, Jr. Day": "마틴 루터 킹 주니어의 날",
        ...
        "National Day": "국경절", # ✨ '독립기념일'에서 '국경절'로 수정
        
        # ✨ 중국 대체 근무일에 대한 영어 이름 추가
        "Day off (substituted from Sunday)": "대체 휴일",
        "Day off (substituted from Saturday)": "대체 휴일",
        
        # 베트남 (VN)
        "Vietnamese New Year's Eve": "뗏 이브",
        "Vietnamese New Year": "뗏 (설날)",
        "Hung Kings' Festival": "흥왕 기념일",
        "Reunification Day": "남부 해방 기념일",
        "International Workers' Day": "국제 노동절",
        "National Day": "독립기념일",

        # 독일 (DE)
        "Good Friday": "성금요일",
        "Easter Monday": "이스터 먼데이",
        "Labour Day": "노동절",
        "Ascension Day": "주님 승천 대축일",
        "Whit Monday": "성령 강림 대축일 월요일",
        "Day of German Unity": "독일 통일의 날", # ✨ 번역 추가
        "Christmas Day": "크리스마스",
        "Second Day of Christmas": "크리스마스 연휴",
    }
