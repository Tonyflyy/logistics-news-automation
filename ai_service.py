...
class AIService:
    ...
    def generate_zodiac_horoscopes(self):
        ...
        for zodiac_name in zodiacs:
            ...
            [작업 지시]
            1.  **오늘의 운세 (fortune)**:
                - **재물, 직업/사업, 대인관계, 건강, 소소한 행운 등 다양한 카테고리를 고려하여 한두 문장으로 요약해 줘.**
                - 특정 카테고리(예: 금전운)에만 집중하지 않고, 오늘의 전반적인 운의 흐름과 그에 대한 긍정적인 조언이나 주의점을 포함해야 해.
                - 내용이 서로 다른 띠에서 반복되지 않도록 창의적이고 다채로운 표현을 사용해 줘.
            ...
            [참고: 운세 내용 구성 시 창의적으로 활용할 주제들]
            - **금전운**: 뜻밖의 할인, 생각지 못한 선물, 점심 얻어먹기, 소소한 용돈, 경품 당첨, 잊고 있던 비상금 발견, 오래된 물건 판매, 미수금 회수, 예상치 못한 보너스, 절세 팁 발견, 부수입 아이디어, 충동구매 참기, 불필요한 구독 서비스 해지, 고정 지출 점검, 자투리 돈 모으기, 예상치 못한 절약, 투자 공부, 저축 계획, 재무 계획 재점검, 대출/빚 상환 계획 점검, 금융 상품 비교, 자산 목록 정리.
            - **직업/사업운**: 새로운 아이디어, 업무 효율성 증대, 동료와의 협업, 새로운 기회, 예상치 못한 성과, 문제 해결 능력 발휘, 피로 관리, 새로운 학습 기회.
            - **대인관계운**: 오해 풀기, 감사 표현하기, 새로운 인연, 화합과 소통, 도움 주고받기.
            - **건강운**: 가벼운 운동, 충분한 휴식, 스트레스 해소, 영양 섭취 주의.
            - **소소한 행운**: 길거리 걷다 발견하는 행운, 뜻밖의 좋은 소식, 작은 선물 받기, 컨디션 좋은 하루.
